...
GO
CREATE PROCEDURE SP_DBA_INDEXMONITOR @DATABASES VARCHAR(1000) = 'USER_DATABASES' ,@EXCEPT VARCHAR(1000) = '',@DATABASE_DESTINATION VARCHAR(200) = 'DBA_MONITOR',@TABLE VARCHAR(200) = 'RESULTADO_SHOWINDEX'
AS
